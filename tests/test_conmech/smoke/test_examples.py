...
examples_2d_samples = {
    ...
    "displacement_3": np.array(
        [
            [ 0.00292959, -0.00169349],
            [ 0.0038936 ,  0.00019177],
            [-0.00017056,  0.00036929],
            [ 0.00323103, -0.00158516],
            [ 0.00358653, -0.00161073],
        ]
    )
    # np.array(
    #     [
    #         [-0.01033522, -0.01252663],
    #         [0.01015619, 0.00739045],
    #         [-0.00168021, 0.00198603],
    #         [-0.0024749, -0.01677869],
    #         [0.00471585, -0.01427191],
    #     ]
    # ),
    # np.array(
    #     [
